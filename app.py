...
# Explicitly define the allowed methods in route call
...
# Its a POST Method
# Expects data only in HTML-FORM Object while calling up the API
...
# POST Method
# Check if request is in form of JSON or HTML FORM
